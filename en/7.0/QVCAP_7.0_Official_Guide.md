...
### 💡 AI 역검증(학습) 프롬프트 가이드
보고서(`Analysis_C01_..._EN.md`)를 AI에 업로드한 뒤, 한 번에 묻지 말고 이렇게 대화를 시작하십시오.
...
### 3-4. Prosecution Record Format (Verification Log)
...
| **E-03 권위 호소 (Authority)** | "이븐 카시르와 위대한 학자들의 합의(Ijma)는 이렇습니다" | "주석은 2차 저작물입니다. 주석가들의 합의가 원문을 보충해야만 이해 가능하다는 것 자체가 D-13(명확성)과의 긴장입니다." |
